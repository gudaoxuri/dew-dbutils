...
package com.ecfront.dew.dbutils;

import com.ecfront.dew.dbutils.dto.Meta;
import com.ecfront.dew.dbutils.dto.Page;
import com.ecfront.dew.dbutils.process.DBExecutor;
import com.ecfront.dew.dbutils.process.DSLoader;
...
public class DewDB {
    ...
    public void open() {
        ...
        try {
            ...
            log.error("[DewDBUtils]Connection open error", e);
        }
    }
    ...
    public void commit() {
        ...
        if (null != conn) {
            try {
                ...
                log.error("[DewDBUtils]Connection commit error", e);
            }
        }
        close();
    }
    ...
    public void rollback() {
        ...
        if (null != conn) {
            try {
                ...
                log.error("[DewDBUtils]Connection rollback error", e);
            }
        }
        close();
    }
    ...
    private void close() {
        ...
        if (null != conn) {
            try {
                ...
                log.error("[DewDBUtils]Connection close error", e);
            }
        }
    }
    ...
    private Connection getConnection() {
        try {
            ...
            log.error("[DewDBUtils]Connection get error.", e);
            throw e;
        }
    }
